...
#define STRING_CONFIG_H_AUTHOR "(GpDevSw, Linear Plus)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "1.1.9" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Auto Bed Level"         // will be shown during bootup in line 2.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // AnyCubic Kossel: GpDevSw (From Manual PID Tune)
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 100.0 // mm. You can set larger, but beware it might run into the bed clamps
  ...
  #define DELTA_HEIGHT 285.31 // // mm. This will be overriden and set in EEPROM when saving Auto Calibrate results

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 133.22 //mm. This will be overriden and set in EEPROM when saving Auto Calibrate results
 ...
 */
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 98 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 100, 400 }
...
#define INVERT_X_DIR true //For TMC2130, you need to reverse the motor connectors
